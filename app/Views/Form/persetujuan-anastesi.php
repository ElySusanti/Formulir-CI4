                    ...
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    : <input type="date" id="v_06" name="v_06" style="width: 100px;" required>
                                </div>
                            </div>
                        </td>
                        <td rowspan="2" style="vertical-align: middle;">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    : <input type="text" id="v_07" name="v_07" style="width: 200px;" required>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    : <input type="text" id="v_08" name="v_08" style="width: 200px;" required>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    : <input type="text" id="v_09" name="v_09" style="width: 200px;" required>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    : <input type="text" id="v_10" name="v_10" style="width: 200px;" required>
                                </div>
                            </div>
                        </td>
                    </tr>
