...
<body>
    <div class="container-fluid" style="font-family: 'Arial Narrow';">
        ...
        <?php foreach ($dataAssessmentformdua as $row) : ?>
                        ...
                        <td>
                            <table style="text-align: left;">
                                ...
                                <tr>
                                    ...
                                    <td>: <input type="date" name="date_of_birth" id="date_of_birth" style="width: 100px;" value="<?php echo $row->DATE_OF_BIRTH; ?>" readonly></td>
                                    <td>
