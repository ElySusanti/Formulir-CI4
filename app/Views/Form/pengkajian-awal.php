    ...
    <div class="container-fluid mt-3" style="font-family: 'Arial Narrow';">
        <form action="">
            <table style="width: 100%;">
                <tr>
                    <td>
                        <img src="<?php echo base_url(); ?>img/logo.png" alt="" style="width: 70px;">
                    </td>
                    <td>
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td colspan="4" rowspan="6">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <img src="<?php echo base_url(); ?>img/skala_angka.png" alt="" style="width: 100%;" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <img src="<?php echo base_url(); ?>img/skala_animasi.png" alt="" style="width: 95%;">
                                    </div>
                                </div>
                            </td>
                        </tr>
