...
<body>
    ...
    <div class="container" style="font-family: Verdana;">
        <?php foreach ($dataAssessmentformlima as $row) : ?>
            <form action="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="cara_bayar" id="cara_bayar" style="width: 200px;" value="<?php echo $row->CARA_BAYAR; ?>" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" name="description" id="description" style="width: 300px;" autofocus>
                    </div>
                    <div class="col-md-3">
