...
<body>
    ...
    <div class="container" style="font-family: Verdana;">
        <?php foreach ($dataAssessmentformenam as $row) : ?>
            <form action="">
                <div class="row mt-5">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-4">
                        <input type="date" name="date_of_birth" id="date_of_birth" style="width: 200px;" min="0" value="<?php echo $row->DATE_OF_BIRTH; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2" style="text-align: right;">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        <input type="text" name="cara_bayar" id="cara_bayar" style="width: 300px;" value="<?php echo $row->CARA_BAYAR; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-2" style="text-align: right;">
                    ...
                    <div class="col">
                        <input type="text" name="employee_id" id="employee_id" style="width: 300px;" value="<?php echo $row->EMPLOYEE_ID; ?>" readonly>&nbsp;
                        <input type="text" name="clinic_id" id="clinic_id" style="width: 200px;" value="<?php echo $row->CLINIC_ID; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="vactination_date" id="vactination_date" style="width: 200px;" value="<?php echo $row->VACTINATION_DATE; ?>" readonly>
                    </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col">
                        <input type="text" name="description" id="description" style="width: 200px;" autofocus>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col">
