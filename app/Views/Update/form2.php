                ...
                <tr style="font-size: 13px; text-align: left;">
                    <td style="width: 33%;">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_01" id="T_01" <?= ($detail['T_01'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_01">Identitas dan gelang pasien</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_02" id="T_02" <?= ($detail['T_02'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_02">Informed consent</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_03" id="T_03" <?= ($detail['T_03'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi1()">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_04" id="T_04" <?= ($detail['T_04'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi2()">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_05" id="T_05" <?= ($detail['T_05'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi3()">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_09" id="T_09" <?= ($detail['T_09'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_09">Obat-obatan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_010" id="T_010" <?= ($detail['T_010'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_010">IV line</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_011" id="T_011" <?= ($detail['T_011'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_012" id="T_012" <?= ($detail['T_012'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_012">Terpasang</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_013" id="T_013" <?= ($detail['T_013'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_014" id="T_014" <?= ($detail['T_014'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi4()">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_015" id="T_015" <?= ($detail['T_015'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_016" id="T_016" <?= ($detail['T_016'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_016">Tidak</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_017" id="T_017" <?= ($detail['T_017'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_018" id="T_018" <?= ($detail['T_018'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_018">Tidak</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_019" id="T_019" <?= ($detail['T_019'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_020" id="T_020" <?= ($detail['T_020'] == "1" ? 'checked' : ''); ?> value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_023" id="T_023" <?= ($detail['T_023'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_024" id="T_024" <?= ($detail['T_024'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_024">Tidak</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_025" id="T_025" <?= ($detail['T_025'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi5()">
                    ...
                    <td style="width: 33%;">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_026" id="T_026" <?= ($detail['T_026'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_026">Lengkap, anggota tim menyebutkan nama dan perannya masing-masing</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_027" id="T_027" <?= ($detail['T_027'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi6()">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_028" id="T_028" <?= ($detail['T_028'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_028">Dilakukan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_029" id="T_029" <?= ($detail['T_029'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_030" id="T_030" <?= ($detail['T_030'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_030">Berapa perkiraan darah yang hilang</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_031" id="T_031" <?= ($detail['T_031'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="T_031">Adakah alat spesifik yang dibutuhkan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_032" id="T_032" <?= ($detail['T_032'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_033" id="T_033" <?= ($detail['T_033'] == "1" ? 'checked' : ''); ?> value="1">
                    ...
                    <td style="width: 33%;">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="T_047" id="T_047" <?= ($detail['T_047'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="t_052" id="t_052" <?= ($detail['t_052'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="t_053" id="t_053" <?= ($detail['t_053'] == "1" ? 'checked' : ''); ?> value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="t_055" id="t_055" <?= ($detail['t_055'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="t_055">Nadi</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="t_056" id="t_056" <?= ($detail['t_056'] == "1" ? 'checked' : ''); ?> value="1">
                                    <label class="form-check-label" for="t_056">Saturasi oksigen (%)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="t_057" id="t_057" <?= ($detail['t_057'] == "1" ? 'checked' : ''); ?> value="1">
                        ...
                        <div class="row">
                            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col">
                                <div class="form-check">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input class="form-check-input" type="checkbox" name="t_059" id="t_059" <?= ($detail['t_059'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi7()">
                                ...
                                <div class="form-check">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input class="form-check-input" type="checkbox" name="t_060" id="t_060" <?= ($detail['t_060'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi8()">
                                ...
                                <div class="form-check">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input class="form-check-input" type="checkbox" name="t_061" id="t_061" <?= ($detail['t_061'] == "1" ? 'checked' : ''); ?> value="1" onclick="fungsi9()">
